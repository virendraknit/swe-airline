...
public class CancelReservation extends HttpServlet {
	 ...
	 *             provided reservation Id, or if there was an issue in communicating
	 *             with the remote service.
	 */
	private Reservation cancelReservation(String reservationId) throws ValidationException {
		try {
